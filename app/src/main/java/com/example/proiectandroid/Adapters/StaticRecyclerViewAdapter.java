...
public class StaticRecyclerViewAdapter extends RecyclerView.Adapter<StaticRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public StaticRecyclerViewAdapter(ArrayList<EntryData> storedImageData, Context context, OnItemClicked clickEvent) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_staticlistitem, parent,false);
